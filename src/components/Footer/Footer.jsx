...
const Footer = () => {
  ...
  <ul className="text-sm md:text-xl py-6 space-y-4">
    <li className="flex items-center space-x-2">
      ...
      <a href="mailto:prakharbarsainya2@gmail.com" className="hover:underline">
        prakharbarsainya2@gmail.com
      </a>
    </li>
    <li className="flex items-center space-x-2">
      <CiLinkedin color="#F7DF1E" size={20} />
      <a href="https://www.linkedin.com/in/prakhar-barsainya-6538ab248/" className="hover:underline">
        LinkedIn
      </a>
    </li>
    <li className="flex items-center space-x-2">
      <FaGithub color="#F7DF1E" size={20} />
      <a href="https://github.com/PrakharBarsainya" className="hover:underline">
        Github
      </a>
    </li>
  </ul>
